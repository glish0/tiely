...
export default function GuestsPage() {
  ...
  const buildInvitationMessage = (group: GuestGroupWithGuests) => {
    ...
    return [
      ...
      ``,
      `Cher/Chère ${displayGuestName},`,
      ``,
      `C’est avec une immense joie que nous vous convions à célébrer notre`,
      ``,
      `union. Votre présence rendrait ce moment encore plus spécial..`,
      ``,
      `Veuillez découvrir votre invitation personnalisée ici:`,
      `${url}`,
      ``,
      `Merci de bien vouloir confirmer votre présence via ce lien afin de`,
      ``,
      `télécharger votre billet d'entrée avec QR Code.`,
      ``,
